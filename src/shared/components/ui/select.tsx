...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between rounded-lg border border-input bg-input-background px-3 py-2 text-sm",
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ...
    {...props}
  >
    <NavArrowDown className="h-4 w-4 rotate-180" />
  </SelectPrimitive.ScrollUpButton>
));
